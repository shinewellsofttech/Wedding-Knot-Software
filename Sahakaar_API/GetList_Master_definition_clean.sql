	   ...
	   ,ISNULL(IM.FullDescription,'') AS FullDescription
	       ...
	       ,(
	           ...
	           SELECT
	               ...
	               ,CASE WHEN ISNULL(IDM.DesignPhoto2,'')='' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thumbnail/' +  LEFT(DesignPhoto2, LEN(DesignPhoto2) - CHARINDEX('.', REVERSE(DesignPhoto2))) + '.webp' END AS DesignPhoto2_Thu
mb
                                                                                                                                                                                                                                                           
	               ,CASE WHEN ISNULL(IDM.DesignPhoto3,'')='' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thumbnail/' +  LEFT(DesignPhoto3, LEN(DesignPhoto3) - CHARINDEX('.', REVERSE(DesignPhoto3))) + '.webp' END AS DesignPhoto3_Thu
mb
                                                                                                                                                                                                                                                           
	               ,CASE WHEN ISNULL(IDM.DesignPhoto4,'')='' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thumbnail/' +  LEFT(DesignPhoto4, LEN(DesignPhoto4) - CHARINDEX('.', REVERSE(DesignPhoto4))) + '.webp' END AS DesignPhoto4_Thu
mb
                                                                                                                                                                                                                                                           
	               ,CASE WHEN ISNULL(IDM.DesignPhoto5,'')='' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thumbnail/' +  LEFT(DesignPhoto5, LEN(DesignPhoto5) - CHARINDEX('.', REVERSE(DesignPhoto5))) + '.webp' END AS DesignPhoto5_Thu
mb
  ...
  BEGIN
	     ...
	     SELECT
	       ...
	       ,(
	           SELECT
	                PEL.Id
	               ,CASE WHEN ISNULL(PEL.DesignPhoto,'') = '' THEN
 '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/' + PEL.DesignPhoto END AS DesignPhoto
	               ,CASE WHEN ISNULL(PEL.DesignPhoto,'') = '' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thumbnail/' +  LEFT
(PEL.DesignPhoto, LEN(PEL.DesignPhoto) - CHARINDEX('.', REVERSE(PEL.DesignPhoto))) + '.webp' END AS DesignPhoto_Thumb
...
hoto2, '''') = '''' 
					 ...
					 ,CASE 
					     ...
					     THEN '''' 
					     ELSE ''https://accountingwkr.shi
newellsofttech.co.in/ItemImages/'' + TBL.DesignPhoto4 
					  END AS DesignPhoto4

					 ,CASE 
					     WHEN ISNULL(TBL.DesignPhoto5, '''') = '''' 
					     THEN '''' 
					     ELSE ''https://accountingwkr.shinewellsofttech.co.in/ItemImages/'' + TBL.D
esignPhoto5 
					  END AS DesignPhoto5
  ...
  BEGIN
	     ...
	     SELECT
	       ...
	       ,(
	           SELECT
	                SEL.Id
	               ,CASE WHEN ISNULL(SEL.
DesignPhoto,'') = '' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/' + SEL.DesignPhoto END AS DesignPhoto
				   ,CASE WHEN ISNULL(SEL.DesignPhoto,'') = '' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thu
mbnail/' +  LEFT(SEL.DesignPhoto, LEN(SEL.DesignPhoto) - CHARINDEX('.', REVERSE(SEL.DesignPhoto))) + '.webp' END AS DesignPhoto_Thumb
  ...
  BEGIN
	     ...
	     SELECT
	       ...
	       ,(
            ...
            ,CASE WHEN ISNULL(PEL.DesignPhoto,'') = '' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thumbnail/' +  LEFT(PEL.DesignPhoto, LEN(PEL.DesignPhoto) - CHARINDEX('.', REVERSE(PEL.DesignPhoto))) + '.webp' END AS DesignPhot
o_Thumb
  ...
  BEGIN
	     ...
	     SELECT
	       ...
	       ,(
	           SELECT
	                SEL.Id
	               ,CASE WHEN ISNULL(SEL.DesignPhoto,'') = '' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/' + SEL.DesignPhot
o END AS DesignPhoto
				   ,CASE WHEN ISNULL(SEL.DesignPhoto,'') = '' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thumbnail/' +  LEFT(SEL.DesignPhoto, LEN(SEL.DesignPhoto) - CHARINDEX('.', REVERSE(SEL.DesignPhoto))) + '.webp' E
ND AS DesignPhoto_Thumb
		   ...
		   ,(
	           SELECT
	                SELOC.Id
				   ,ISNULL(SELOC.F_LedgerMaster,0) AS F_LedgerMaste
r
  ...
  BEGIN
	     ...
	     SELECT
	       ...
	       ,(
            ...
            ,CASE WHEN ISNULL(RML.DesignPhoto,'') = '' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thumbnail/' +  LEFT(RML.DesignPhoto, LEN(RML.DesignPhoto) - CHARINDEX('.', REVERSE(RML.DesignPhoto))) + '.webp' END AS DesignPhot
o_Thumb
  ...
  BEGIN
	     ...
	     SELECT
	       ...
	       ,(
            ...
            ,CASE WHEN ISNULL(RRL.DesignPhoto,'') = '' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thumbnail/' +  LEFT(RRL.DesignPhoto, LEN(RRL.DesignPhoto) - CHARINDEX('.', REVERSE(RRL.DesignPhoto))) + '.webp' END AS DesignPhot
o_Thumb
...
entReturnH = RRH.Id
  ...
  BEGIN
	     ...
	     SELECT
	       ...
	       ,(
	           ...
	           SELECT
				   ...
				   ,CASE WHEN ISNULL(SEL.DesignPhoto,''
) = '' THEN '' ELSE 'https://accountingwkr.shinewellsofttech.co.in/ItemImages/Thumbnail/' +  LEFT(SEL.DesignPhoto, LEN(SEL.DesignPhoto) - CHARINDEX('.', REVERSE(SEL.DesignPhoto))) + '.webp' END AS DesignPhoto_Thumb
	   ...
	   FROM SalesEntryH SEH
	   OUTER APPLY(SELECT ISNULL(SUM(MRL.PaidAmount),0) AS PaidAmount FR
OM MoneyReceiptL MRL WHERE MRL.F_SalesInvoiceH = SEH.Id) AS tblPaidAmount
	   WHERE SEH.Id = @Id
